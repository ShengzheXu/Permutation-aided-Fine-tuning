...
import sys
sys.path.insert(0, './baselines/be_great')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default=f"great", help="model name")
    ...
    for task in task_list:
        ...
        for data_path in todo_list:
            ...
            for i in range(args.exptimes):
                ...
                with open(f"{log_folder}/time_great.txt", "a") as f:
                    f.write(f"great,{os.path.basename(args.data_path)},{i},{(time_train_end - time_begin).seconds}, {(time_end - time_sample_begin).seconds}, {args.order}\n")